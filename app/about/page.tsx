        ...
        <div className="flex justify-between items-center mt-15">
          ...
          <div className="flex flex-col gap-15 ml-20">
            <div className="flex flex-col gap-10">
              <div className="text-[#FC6216] text-4xl">OUR MESSION</div>
              <div className="flex flex-col gap-15">
                <div className="text-lg">
                  Founded in 2024,
                  <span className="text-[#F95A20]"> ZEKA SPORTS </span>
                ...
                <div className="flex gap-10">
                  <div className="flex flex-col gap-2 p-2 border-[#FC6216] border-l-2">
                    <div className="text-[#FC6216]">Durability</div>
                  ...
                  <div className="flex flex-col gap-2 p-2 border-[#FC6216] border-l-2">
                    <div className="text-[#FC6216]">Innovation</div>
                    <div className="text-[12px]">
