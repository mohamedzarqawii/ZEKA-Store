  ...
  return (
    <div className="mx-10">
      <div className="flex justify-center items-center h-[calc(100vh-155px)]">
        {/* body */}
        <div className="flex flex-col justify-center items-center gap-8 bg-[#1a1a1a]/20 backdrop-blur-md p-12 border border-[#F97A14] rounded-3xl w-135 h-fit">
          {/* 1 */}
          <div className="flex flex-col justify-center items-center gap-4 w-full">
            <div className="text-[#F97A14] text-4xl">JOIN THE ELITE</div>
